...
4. После работы добавь в NOTES.md:
   - что сделано
   - что проверить
   - что стоит перенести в MEMORY.md
   - что стоит добавить в TASKS.md
...
> Для чего файл: сюда агент пишет итоги, вопросы и предложения.
> Кто редактирует: агент и человек.
> Человек переносит важное из NOTES.md в MEMORY.md или TASKS.md.
> Старые записи можно очищать после переноса.
